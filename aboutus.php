...
<div class="title">
    ...
    <div class="search-box">
        ...
        <div class="language">
            <a  style="color: white" href="aboutus.php?lang=eng">EN</a>
            <a  style="color: white" href="aboutus.php?lang=kaz">KZ</a>
            <a style="color: white" href="aboutus.php?lang=rus">RU</a>
            <a  style="color: white" href="aboutus.php?lang=ger">DE</a>
        </div>
    </div>
</div>
...
<div class="sidebar">
    <a href="index.php"> <?php Echo $lang['home'];?> </a>
    <a  class="active" href="aboutus.php">					<?php Echo $lang['about'];?></a>
    <a href="archive.php">				<?php Echo $lang['archive'];?></a>
    <a href="speakers.php">				<?php Echo $lang['speakers'];?></a>
    <a href="gallery.php">				<?php Echo $lang['gallary'];?></a>
           <!-- Work in proggressssss <a href="videos.php">	< ? php Echo $lang['video'];?></a>-->
